    ...
    <div class="testimonial-box col-3">
      ...
      <div class="box-top">
        ...
        <div class="profile">
          ...
          <!——name-and-username——>
          <div class="name-user">
            <strong>${topics[i].Subject}</strong>
        ...
        <div style="display:flex;justify-content : center;flex-direction: column;">
          ...
          <span name="p_num${topics[i].Review_ID}" id="p_num${topics[i].Review_ID}" class="p_num" style="padding-left : 10px">${topics[i].Recommand_Count}</span>
                      ...
                      <tr class="cart__list__detail">
                        ...
                        <td>
                          <div class="information">
                            <span class="cart__list__smartstore" id="subject${i}"><p>${lecture[i].Subject}</p></span>
