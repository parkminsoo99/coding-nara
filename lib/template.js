    ...
    <div class="testimonial-box col-3">
      ...
      <div class="box-top">
        ...
        <div style="display:flex;justify-content : center;flex-direction: column;">
                        <button id="p_button${i}" style="border: none; background-color:transparent;"onclick="javascript:review_list.recommand_change_num(${i});"><i class="bi bi-heart-fill fs-3 text-primary"></i></button>
