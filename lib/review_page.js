...
const date_now = new Date(utcNow + koreaTimeDiff); 
var url = require('url')
                        ...
                        (error2, ITD_result) => {
                            ...
                            db.query(
                                ...
                                function (error3, Reviews) {
                                    if (error3) 
                                        throw error3
                                    if (Reviews[0].Recommand_Count === 1) {
                                        db.query(
                                            ...
                                            function (error4, Student_result) {
                                                ...
                                                db.query(
                                                    ...
                                                    UPDATE Section SET Recommand_Count = ? where Student_ID = ? and Teacher_ID = ? and Course_ID = ? and TIME_ID = ? and DATE_ID = ?;
                                                    `,
                                                    [
                                                        point + 2000,
