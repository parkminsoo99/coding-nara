                            ...
                            */
                            ...
                            if(rsp.status == 'paid' && rsp.paid_amount == 100){
                                if (rsp.success) {
                                    ...
                                    alert(msg);
                                    window.location.href = 'http://localhost:3000/enroll/payment/complete?point='+ discount_price + "&course_id=" + ${Course_Id} + "&time_id=" + ${Time_Id} + "&date_id=" + ${Date_Id} + "&teacher_id=" + ${Teacher_Id} + "&count=" + count_num + "&merchant_uid=" + rsp.merchant_uid + "&original_price=" + original_price + "&final_price=" + final_price;
                                    } 
                                    else {
                                        var msg = '결제에 실패하였습니다.';
