...
router.get('/', (req, res) => {
    ...
    <span class="btn__txt">코딩나라 커리큘럼</span>
    ...
    <span class="btn__txt"><a href='#entry'>스크레치 / ENTRY</a></span>
    <i class="btn__bg" aria-hidden="true"></i>
    <i class="btn__bg" aria-hidden="true"></i>
    <i class="btn__bg" aria-hidden="true"></i>
    <i class="btn__bg" aria-hidden="true"></i>
  ...
  <button type="button" class="btn btn--green">
    <span class="btn__txt"><a href='#app'>앱 인벤터</a></span>
    <i class="btn__bg" aria-hidden="true"></i>
    <i class="btn__bg" aria-hidden="true"></i>
    <i class="btn__bg" aria-hidden="true"></i>
    <i class="btn__bg" aria-hidden="true"></i>
  ...
  <button type="button" class="btn btn--red">
    <span class="btn__txt"><a href='#python'>웹 사이트 제작 / 파이썬</a></span>
    <i class="btn__bg" aria-hidden="true"></i>
    <i class="btn__bg" aria-hidden="true"></i>
    <i class="btn__bg" aria-hidden="true"></i>
    <i class="btn__bg" aria-hidden="true"></i>
  ...
  <button type="button" class="btn btn--blue">
    <span class="btn__txt"><a href='#mine'>Java / 마인크래프트 / C언어</a></span>
    <i class="btn__bg" aria-hidden="true"></i>
    <i class="btn__bg" aria-hidden="true"></i>
    <i class="btn__bg" aria-hidden="true"></i>
    <i class="btn__bg" aria-hidden="true"></i>
